# 📊 DACA – Data Analytics Career Accelerator Portfolio

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Kalju%20Tamme-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kalju-tamme/)
[![Email](https://img.shields.io/badge/Email-kalju.tamme%40gmail.com-0078D4?style=for-the-badge&logo=microsoftoutlook&logoColor=white)](mailto:kalju.tamme@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-Kolju3-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Kolju3)
...
| Week 9 | Career Preparation | **Roll B** – Technical Interviewer | Prepared for technical interviews, refined CV and LinkedIn profile, and practiced interview scenarios |  :white_check_mark: |
...
My DACA portfolio is organized into a structured hierarchy that separates core materials, workshop environments, and weekly assignments. Each week contains its own code, feedback, materials, and results.
...
│   ├── CORE_code/                  # Core scripts and utilities
│   ├── CORE_RAG/                   # Core RAG (Retrieval-Augmented Generation) context
│   ├── DATA/                       # Datasets
│   │   ├── Backup/                 
│   │   │   └── Bonus/              # Backup of bonus data
│   │   ├── Bonus/                  # Extra datasets
│   │   ├── Core/                   # Primary datasets
│   │   └── Schema/                 # Database schemas
│   └── INTRODUCTION/               # Course introduction materials
│
├── WORKSHOP/                       # Workshop environment
│   ├── output/                     # Generated outputs
│   ├── __pycache__/                # Python cache
│   └── .venv/                      # Python virtual environment
│
├── Week_0/                         # Week 0 (Setup)
│   ├── Week_0_Code/                # Setup scripts & configurations
│   ├── Week_0_Feedback/            # My personal feedback & self-assessment
│   ├── Week_0_Materials/           # Resources & references
│   │   ├── [non-systematic]/       # Teacher-provided materials
│   │   └── Week_0_RAG/             # Scenario context
│   │       ├── [scenario].md       # Hypothetical business problem
│   │       ├── [summary].md        # Summary of the scenario
│   │       └── [audio].mp3         # Audio summary of the scenario
│   └── Week_0_Results/             # Deliverables & outcomes
│       ├── Week_0_Conclusions/     # Written conclusions
│       ├── Week_0_Pictures/        # Screenshots & visuals
│       ├── Week_0_Presentation/    # Presentation slides
│       └── Week_0_Tables/          # Data tables & exports
│
├── Week_1/                         # (Identical structure for Weeks 1-9)
│   └── ...
├── Week_2/
│   └── ...
