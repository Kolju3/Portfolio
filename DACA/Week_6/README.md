...
This folder contains the **modular Python code** for the Week 6 marketing dashboard built with **Plotly and Streamlit** (Track B). Building upon the modular structure I established in Week 5, this version has been **further refactored** with clearer separation of concerns, enhanced KPI calculations, and richer chart annotations.
